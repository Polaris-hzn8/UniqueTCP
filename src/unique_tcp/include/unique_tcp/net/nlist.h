...
#define offset_to_parent(addr, type, member) (type*)((char*)addr - offsetof(type, member))

#define nlist_entry(addr, type, member) ((addr) ? offset_to_parent((addr), type, member) : (type*)0)
