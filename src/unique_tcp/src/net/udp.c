...
net_err_t udp_sendto(struct _sock_t* sock,
                     const void* buf,
                     size_t len,
                     int flags,
...
net_err_t udp_recvfrom(struct _sock_t* sock,
                       void* buf,
                       size_t len,
                       int flags,
...
net_err_t udp_connect(sock_t* s, const struct x_sockaddr* addr, const x_socklen_t addr_len) {
...
net_err_t udp_out(ipaddr_t* dest_ip, uint16_t dest_port, ipaddr_t* src_ip, uint16_t src_port, pktbuf_t* buf) {
